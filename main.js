...
for(let i = 0; i < mixedSignNumbers.length; i++){
  if(mixedSignNumbers[i] % 2 === 0 || (-1 * mixedSignNumbers[i]) % 2 ===0){
...
const newt = [5, NaN, 'pretty', null, 'pathetic']
...
const students3 = students.slice(3, 11)
...
let dinosaurs3 = dinosaurs.reverse()
...
for(let i = 0; i < primsec.length; i++){
  console.log(primsec[i])
}
